...
export function createReactElementsWithXMLRoot(xmlRootElement, media) {
    this.media = media;
...
export function mapToReact(rootElement, completion) {
...
export function createReactElementForTag(tag, index) {
    return new Promise((resolve, reject) => {
...
export function createImageElement(tag, index, completion) {
...
export function createParagraphElement(tag, index, completion) {
...
export function createBoldTextElement(tag, index, completion) {
    this.mapToReact(tag, (childElements => {
...
export function createItalicTextElement(tag, index, completion) {
    this.mapToReact(tag, (childElements => {
        completion(React.createElement(Text, { style: [styles.text, styles.italic], key: index }, childElements));
    }));
}

export function createCrossheadTextElement(tag, index, completion) {
    this.mapToReact(tag, (childElements => {
        completion(React.createElement(Text, { style: [styles.crosshead], key: index }, childElements));
    }));
}

export function createLinkElement(tag, index, completion) {
...
export function createListElement(tag, index, completion) {
    this.mapToReact(tag, (childElements => {
...
export function createListItemElement(tag, index, completion) {
...
export function createVideoElement(tag, index, completion) {
...
export function imageForId(imageId) {
...
export function handleImageUrl(id) {
...
export function fetchVideoInfo(videoId, completion) {
